/*
    ...
    Revision History:
        Chapter8 - added constructor for Token_stream to use istream reference
...
public:
    ...
    Token_stream(istream& input);   // Make a Token_stream that uses istream
